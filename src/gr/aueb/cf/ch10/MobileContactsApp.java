...
public class MobileContactsApp {
    ...
    public static String [] validateInsertContact(String[] contact){
        ...
        if (!contact[0].matches("\\S+") || contact[1].length() < 2) {
            errorsArray[1] = "invLastname";
        }
        if (!contact[0].matches("\\S+") || contact[2].length() < 10) {
    ...
    public static String[][] getAllContactsServices() throws Exception {
        String[][] allContacts;
