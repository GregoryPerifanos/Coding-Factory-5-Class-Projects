...
//
        ...
        String aueb = "Athens Uni     of Ecp and Bus";
...
//        }
    ...
    public static boolean startsWithUppercaseEndingWithIng (String s) {
        return s.matches("[A-Z]ing");
    }

    public static boolean startsWithUppercaseOrLowercaseEndingWithIng (String s) {
        return s.matches("[a-zA-Z][iI][nN][gG]");
    }

    public static boolean isAnySymbolFollowedBySpaceAndDigit (String s) {
        return s.matches(".\\s\\d"); // -> double \\ is to cansel the first \
    }
