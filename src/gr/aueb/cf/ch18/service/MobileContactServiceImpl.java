...
public class MobileContactServiceImpl implements IMobileContactService {
    ...
    @Override
    public MobileContact insertMobileContact(MobileContactInsertDTO mobileContactInsertDTO) throws PhoneNumberAlreadyExistsException, UserIdAlreadyExistsException {
    ...
    @Override
    public MobileContact updateMobileContact(MobileContactUpdateDTO oldDTO, MobileContactUpdateDTO newDTO) throws ContactNotFoundException, PhoneNumberAlreadyExistsException, UserIdAlreadyExistsException {
        ...
        try {
            ...
            if (!dao.userIdExists(oldDTO.getId())) {
